<?php
// Database connection
$conn = new mysqli("localhost", "root", "onelasalle", "db2");
// Check connection
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO absence_slip (parent_first_name, parent_last_name, student_first_name, student_last_name, grade_level, section, start_date, end_date, email, reason, lc_no, medical_cert_filename, medical_cert_filepath)
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        <div class='container'>
            ...
            <div class='success-message'>
                Your submission has been received successfully. A confirmation email has been sent to you at <strong>$email</strong>";
                
        if (!empty($teacherEmail)) {
            echo " and to your teacher at <strong>$teacherEmail</strong>";
        }
